...
export const getBalances = (id) => request(`/employees/${id}/balances`);
...
export const cancelLeave = (requestId) =>
  request(`/leave/cancel/${requestId}`, { method: 'POST' });

// ── Manager ───────────────────────────────────────────────────────
export const getPendingRequests = (managerId) =>
  request(`/manager/${managerId}/pending`);

export const reviewRequest = (requestId, action, comment, managerId) =>
  request(`/leave/review/${requestId}`, {
    method: 'POST',
    body: JSON.stringify({ action, comment, manager_id: managerId }),
  });
...
export const getAuditLog = () => request('/admin/audit-log');
